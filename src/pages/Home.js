        ...
        <main className='container-main-base'>
          <div className='div-container-contatos1'>
            ...
            <div className='links-contatos'>
              <a
                className='link-logo'
                href='https://www.linkedin.com/in/thales-david-ferreira-a47378107/'
                target='_blank'
                rel='noopener noreferrer'
              >
            ...
            <div className='links-contatos'>
              <a
                className='link-logo'
                href='https://github.com/ThalesDFerreira/'
                target='_blank'
                rel='noopener noreferrer'
              >
            ...
            <div className='links-contatos'>
              <a
                className='link-logo'
                href='https://www.facebook.com/thalesferreira190/'
                target='_blank'
                rel='noopener noreferrer'
              >
            ...
            <div className='links-contatos'>
              <a
                className='link-logo'
                href='mailto:thalesferreira190@gmail.com/'
                target='_blank'
                rel='noopener noreferrer'
              >
          ...
          <div className='container-home'>
            <div id='container-div-main'>
              ...
              <div>
                <h2 id='text2'>
                  Muito prazer ! Sou Desenvolvedor de Software.
                </h2>
              </div>
